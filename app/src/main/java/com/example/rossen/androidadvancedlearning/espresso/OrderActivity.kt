...
class OrderActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val menuToolbar = findViewById<View>(R.id.order_toolbar) as Toolbar
       // setSupportActionBar(menuToolbar)
        supportActionBar!!.setTitle(getString(R.string.order_title))
        ...
        val teaNameTextView = findViewById<View>(R.id.tea_name_text_view) as TextView
    ...
    private fun setupSizeSpinner() {
        ...
        val mSizeSpinner = findViewById<View>(R.id.tea_size_spinner) as Spinner
    ...
    private fun setupMilkSpinner() {
        ...
        val mSizeSpinner = findViewById<View>(R.id.milk_spinner) as Spinner
    ...
    private fun setupSugarSpinner() {
        ...
        val mSizeSpinner = findViewById<View>(R.id.sugar_spinner) as Spinner
    ...
    companion object {
        ...
        val EXTRA_TOTAL_PRICE = "com.example.android.teatime.EXTRA_TOTAL_PRICE"
        val EXTRA_TEA_NAME = "com.example.android.teatime.EXTRA_TEA_NAME"
        val EXTRA_SIZE = "com.example.android.teatime.EXTRA_SIZE"
        val EXTRA_MILK_TYPE = "com.example.android.teatime.EXTRA_MILK_TYPE"
        val EXTRA_SUGAR_TYPE = "com.example.android.teatime.EXTRA_SUGAR_TYPE"
        val EXTRA_QUANTITY = "com.example.android.teatime.EXTRA_QUANTITY"
    }
}