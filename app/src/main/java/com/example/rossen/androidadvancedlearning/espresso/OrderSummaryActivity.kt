...
class OrderSummaryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val menuToolbar = findViewById<View>(R.id.order_summary_toolbar) as Toolbar
       // setSupportActionBar(menuToolbar)
        supportActionBar!!.setTitle(getString(R.string.order_summary_title))
    ...
    private fun displayOrderSummary(teaName: String, price: Int, size: String, milkType: String,
        ...
        val teaNameTextView = findViewById<View>(
                R.id.summary_tea_name) as TextView
        teaNameTextView.text = teaName

        // Set quantity in order summary
        val quantityTextView = findViewById<View>(
                R.id.summary_quantity) as TextView
        quantityTextView.text = quantity.toString()

        // Set tea size in order summary
        val sizeTextView = findViewById<View>(
                R.id.summary_tea_size) as TextView
        sizeTextView.text = size

        // Set milk type in order summary
        val milkTextView = findViewById<View>(
                R.id.summary_milk_type) as TextView
        milkTextView.text = milkType

        // Set sugar amount in order summary
        val sugarTextView = findViewById<View>(
                R.id.summary_sugar_amount) as TextView
        sugarTextView.text = sugarType

        // Set total price in order summary
        val priceTextView = findViewById<View>(
                R.id.summary_total_price) as TextView
